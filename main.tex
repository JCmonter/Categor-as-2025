...
\begin{ej}[Categorías Concretas]\label{Categorías concretas}
    ...
    \begin{itemize}
        ...
        \item La categoría $\Pos$ está conformada por... 
    \end{itemize}
\end{ej}
...
\begin{proof}
    Tenemos que que ver que para todo par de objetos $A,B\in\C$ la función $\C_\bullet:\C(A,B)\to[\C^\op,\Con](\C_A,\C_B)$, inducida por el funtor de yoneda,
...
Notemos que el morfismo $\id$ es un morfismo de marco. Además, estos son cerrados bajo composiciones. Por lo tanto, obtenemos la categoría de marcos y como mencionamos antes, esta es denotada por $\Frm$.\\
...
Queremos identificar las álgebras para las respectivas monadas que define esta adjunción.
