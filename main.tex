...
\begin{ex}[Cokernel de un homomorfismo]
    ...
    \end{tikzcd}\]
    donde $\pi:H\to \Cokr(f)$ es la proyección canónica, que manda cada $h\in H$ a su clase lateral $h\im(f)\in Coker(f)$; $0$ es el homomorfismo trivial que manda todo elemento de su dominio
