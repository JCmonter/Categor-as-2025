...
dado por
  ...
  \index[Simbolos]{$\sqsubseteq$ orden de especialización}
...
marcos $\chi_s:\cal OS\to\cal O\{*\}\simeq 2$ 
\index[Simbolos]{$\chi_s$ morfismo de marcos}
dado como
\[
  \chi_s(u) =
  \begin{cases}
...
\begin{definition}
  ...
  \index[Simbolos]{$\pt A$ conjunto de todos los puntos de  $A$}
\end{definition}
...
se sigue que $U_A:A\to\cal O\pt A$\index[Simbolos]{$U_A$ reflexión espacial de $A$}
 es un
...
\begin{remark}
  ...
  \begin{enumerate}
    ...
    \item
      ...
      \[
        S(a)=\Inf \{p\in \pt A|a\leq p\}\index[Simbolos]{$S$ núcleo de $U_A$}
      .\]
    \item
