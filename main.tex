...
\begin{ej}[Funtores en base a objetos]
    ...
    \begin{itemize}
        ...
        objeto $X\in\C$ el producto $A\times X\in\C$, y a cada flecha $X\xrightarrow{f}Y\in\C$ le asigna la flecha $(\id_A,f):A\times X\to A\times Y\in\C$ dada
        ...
        $X\supseteq A\longleftrightarrow \chi_A\in 2^X$, donde $\chi_A$ mapea $x\in X$ a $1\in 2$ si y solo si $x\in A$.
